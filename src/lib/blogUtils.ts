...
import makeGoodVsStripOutImage from "@/assets/blog/make-good-vs-strip-out-vs-defit-melbourne.webp";
...
const imageMap: Record<string, unknown> = {
  ...
  'make-good-vs-strip-out-vs-defit-melbourne': makeGoodVsStripOutImage,
};
