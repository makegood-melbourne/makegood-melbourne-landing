...
import propertyManagerGuideImage from "@/assets/blog/property-manager-make-good-melbourne.webp";
...
const imageMap: Record<string, unknown> = {
  ...
  'property-manager-make-good-melbourne': propertyManagerGuideImage,
};
