...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Melbourne specialists in clear polycarbonate roofing sheet replacement for warehouses and industrial facilities. End of lease make good compliance and vacant property upgrades with certified workmanship and compliant asbestos disposal.",
    metaDescription: "Clear polycarbonate roofing sheets Melbourne. Skylight replacement for make good and property upgrades. Certified workmanship, compliant asbestos disposal. Free quotes.",
    heroText: "Replacing aged, yellowed or damaged skylights as part of your make good scope or property upgrade. Clear polycarbonate roofing sheets that restore natural light and meet landlord expectations.",
