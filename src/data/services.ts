...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Most of our polycarbonate skylight work comes from two situations: end-of-lease make good handovers and owners upgrading vacant warehouses before re-leasing. We replace cracked, leaking and yellowed rooflight sheets and deliver a handover-ready result with the paperwork landlords and agents expect.",
    metaDescription: "Polycarbonate skylight replacement Melbourne for make good and vacant property upgrades. Handover-ready documentation, certified workmanship, compliant asbestos disposal.",
    heroText: "End-of-lease make good or pre-lease upgrade: we replace failed polycarbonate skylight sheets, restore natural light, and finish with the documentation needed for sign-off.",
