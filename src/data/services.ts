...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Yellowed skylights failing your lease handover? Or preparing a vacant warehouse for new tenants? We replace aged, cracked and leaking polycarbonate roofing sheets—whether it's part of your end-of-lease obligations or a smart upgrade before re-leasing.",
    metaDescription: "Skylight replacement Melbourne for make good and property upgrades. Polycarbonate roofing sheets. Certified workmanship, compliant asbestos disposal. Free quotes.",
    heroText: "Yellowed skylights holding up your make good? Or upgrading your vacant property before it hits the market? We handle the lot—removal, replacement, and all the documentation your landlord or agent needs.",
